# PandOSsh - Phase 2 (The Nucleus)

This repository contains the implementation of **Phase 2** for the PandOSsh operating system on uRISCV. This phase implements the **Nucleus layer** (Level 3), responsible for process scheduling, exception and interrupt handling, and system services.
...
4. Success condition: The system should print `p1 finishes OK -- TTFN` and then halt.
